		...
		<div className="h-screen justify-center">
			<center className="pt-24 m-auto">
				<svg className="emoji-404 " enableBackground="new 0 0 226 249.135" height="249.135" id="Layer_1"
					...
					<circle cx="68.732" cy="93" fill="#1C398E" r="9"/>
					<path
					...
					<circle cx="156.398" cy="93" fill="#1C398E" r="9"/>
					...
					<path
						...
						fill="#FFEFB5"/>
					<circle cx="113" cy="113" fill="none" r="109" stroke="#1C398E" strokeWidth="8"/></svg>
				<div className=" tracking-widest mt-4">
					<span className="text-blue-900 text-6xl block"><span>4  0  4</span></span>
					<span className="text-gray-500 text-xl">Извини, но такая страница не найдена!</span>
